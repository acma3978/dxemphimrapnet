 ...
 * @release:	2012.08.29
*/
class Light_Model_User extends Light_Model {
	...
	*/
	public function get_user_by_id($user_id, array $fetch_options = array())
	{
		$items = $this->get_users(array('user_id' => $user_id), $fetch_options);
	 ...
	 * @return 	array|boolean
	*/
	public function get_user_by_name($username, array $fetch_options = array())
	{
		$items = $this->get_users(array('username' => $username), $fetch_options);
	...
	*/
	 ...
	 * @return 	array
	*/
	public function get_users(array $conditions = array(), array $fetch_options = array())
	{
		$join_options = $this->prepare_user_join_options($fetch_options);
		$where_clause = $this->prepare_user_conditions_for_clause($conditions);
		$order_clause = $this->get_order_by_clause($fetch_options, 'user.user_id');
