...
class Light_Curl{
    ...
    public function __construct($base_url = null)
    {
        ...
        $this->headers = new Light_CaseInsensitiveArray();
    ...
    private function parseHeaders($raw_headers)
    {
        ...
        $http_headers = new Light_CaseInsensitiveArray();
    ...
    {
        $request_headers = new Light_CaseInsensitiveArray();
    ...
    private function parseResponseHeaders($raw_response_headers)
    {
        ...
        $response_headers = new Light_CaseInsensitiveArray();
