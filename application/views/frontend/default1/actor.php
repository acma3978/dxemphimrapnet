...
<div id="main-box-actor">
    ...
    </header><!--end#header-actor-->

    <main id="wrapper-actor" class="container">
        <div class="col-lg-3 wg-idol-info">

            <div class="addon-idol-info"><a href="https://www.vietstar.net/dien-vien-angela-phuong-trinh"
                                            title="Angela Phương Trinh">
                    <div class="idol-avatar">
                        <div class="avatar-circle">
                            <div>
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 175 175" style="enable-background:new 0 0 175 175;" xml:space="preserve"><style
                                        type="text/css">.st0 {
                                            opacity: 0.2;
                                            fill: #27b2f3;
                        ...
                        <img class="img-circle"
                             src="https://cdn01.vietstar.net/150x150/avatar/dien-vien-angela-phuong-trinh.jpg"></div>
                    <h1 class="idol-name">{$actorinfo.title}</h1></a>
            ...
            <div id="profile-item-rate"></div><!--end#profile-item-rate-->
                ...
                <ul>
                    ...
                    <li>
                        <a href="https://www.vietstar.net/hot-girl-ngoc-trinh">
                            ...
                            </div><i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </li>
                    </c:each>
                </ul>
            </div>
    ...
    </main><!--end#wrapper-actor-->

    <nav id="box-film-cate"></nav><!--end#box-film-cate-->

    <footer id="footer-actor"></footer><!--end#footer-actor-->
</div><!--end.main-box-actor-->
