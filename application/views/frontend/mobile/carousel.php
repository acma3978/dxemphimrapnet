            ...
            <c:each from="$phim_hot" value="$film">
                        ...
                        <span class="label">{$film.status}</span>
                           ...
                           <c:if is="{$film.image_url} != NULL">
                                    <img class="img-film" src="{$cache_link_img}{$film.image_url}" title="{$film.title}" alt="{$film.title}" style="height: 268.38px;">
                                    <c:else />
                                    <img class="img-film" src="{$cache_link_img}{$film.image_url_o}" title="{$film.title}" alt="{$film.title}" style="height: 268.38px;">
                                </c:if>
